...
public class ShopListServiceProxy implements IShoppingListService {
	private static final String listURL = "http://localhost:8080/rst1-service/rest/list";
	private static final String itemURL = "http://localhost:8080/rst1-service/rest/item/{product}";
